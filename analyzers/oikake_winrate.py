...
# 1st, 2nd, 3rd Riichi winrate, drawrate and dealin rate by wait width and turn. Lateral movement rate is implied.
...
output = "./results/OikakeWinrate.csv"

class OikakeWinrate(LogHandAnalyzer):
    def __init__(self):
        super().__init__()
